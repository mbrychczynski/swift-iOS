...
//  HotProspects
//
//  Created by Mateusz Brychczynski on 19/06/2023.
//
...
struct ProspectsView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .sheet(isPresented: $isShowingScanner) {
                CodeScannerView(codeTypes: [.qr], simulatedData: "Mateusz Brychczynski\nmateusz@mail.com", completion: handleScan)
            }
        }
    }
    ...
    var title: String {
        ...
        case .uncontacted: return "Unconctated people"
        }
    }
